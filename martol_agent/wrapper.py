...
class AgentWrapper(BaseWrapper):
    ...
    def _build_system_prompt(self) -> str:
        ...
        prompt = (
            ...
            f"- brief_update: Update the project brief sections (goal, stack, "
            f"conventions, phase, notes). Provide any combination of fields to "
            f"merge into the existing brief. Use this when asked to fill or "
            f"update the brief.\n\n"
